...
# finita qualsevol. 'b' representa l'atom de mida 0

def BoltmannSamplerSequencia(A,x):
    u = np.random.uniform(0,1)
    #print(u)
    #print(generatriu_avaluada(A,x))
...
print(BoltmannSamplerSequencia(A,0.45))  #esta definida per x < 1/2 ja que s'ha de complir
                                            # que 1 > A(x) = 2x